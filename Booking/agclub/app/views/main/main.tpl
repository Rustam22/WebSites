...
{block name="content"}
	...
	<div class="show-more" page-number="1" data-url="{$app_url}/categories/" {if !$enable_more}style="display: none;"{/if}><a href="javascript:showMore();" class="show-more-a" style="text-decoration: none; color: #fff;">Daha artıq göstər</a></div>
{/block}