<?php /* Smarty version Smarty-3.1.8, created on 2017-04-18 18:20:35
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/agclub/views/main/main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140636058258c1f7e67e3c82-04287941%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b17eb25fc24a1022b2a7e37a89715a6106163d84' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/agclub/views/main/main.tpl',
      1 => 1397816820,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '140636058258c1f7e67e3c82-04287941',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_58c1f7e6adc258_55931488',
  'variables' => 
  array (
    'app_url' => 0,
    'static_url' => 0,
...
<?php if ($_valid && !is_callable('content_58c1f7e6adc258_55931488')) {function content_58c1f7e6adc258_55931488($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/Applications/XAMPP/xamppfiles/htdocs/agclub/core/libs/smarty/plugins/modifier.date_format.php';
?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>AGClub.az </title>
...
/img/sitemap-icon.png" /></a></li>
	...
	<div class="center-container hide-in-767 hide-in-479">
		<div id="calculator-container">
			<div id="calculator-title" class="show-in-767"><span class="red-border italic"><?php echo $_smarty_tpl->tpl_vars['messages']->value['common']['calc_title'];?>
</span>: </div>
			<div id="calculator-left">
				<div class="font16" id="calculator-left-title">
					<span class="red-border italic hide-in-767"><?php echo $_smarty_tpl->tpl_vars['messages']->value['common']['calc_title'];?>
 :</span> <span class="bold" style="float: right; margin-top: 1%; margin-right: 1%;"><?php echo $_smarty_tpl->tpl_vars['messages']->value['calculator']['category'];?>
:</span> 
				</div>
...
/img/select-arrow.png" /></div>
 ...
 $_from = $_smarty_tpl->tpl_vars['calculatorCategories']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['v']->key => $_smarty_tpl->tpl_vars['v']->value){
$_smarty_tpl->tpl_vars['v']->_loop = true;
 $_smarty_tpl->tpl_vars['k']->value = $_smarty_tpl->tpl_vars['v']->key;
?>
									<div class="select-option" key="<?php echo $_smarty_tpl->tpl_vars['v']->value->id->value;?>
" ><?php echo $_smarty_tpl->tpl_vars['v']->value->categoryItemTitle->value;?>
</div>
								<?php } ?>
							</div>
							<input type="hidden" />
			...
			<div id="calculator-right">
				<div class="font16" id="category-right-title"><?php echo $_smarty_tpl->tpl_vars['messages']->value['calculator']['object'];?>
:</div>
				<div id="object-select-container">
					<div id="object-select">
						<div class="select-container select-box relative">
							<div class="selected-value-container">
								<div class="selected-value"><?php echo $_smarty_tpl->tpl_vars['messages']->value['common']['choose_obj'];?>
</div>
								<div class="selected-value-pointer"><img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/select-arrow.png" /></div>
								<div class="clear"></div>
							...
							<div class="select-options-container absolute hide" style="z-index: 999;">
								<div class="select-option" key="1" ><?php echo $_smarty_tpl->tpl_vars['messages']->value['common']['choose_obj'];?>
</div>
							</div>
							<input type="hidden" />
						</div>
				...
				<div id="calculator-result" class="font16"><?php echo $_smarty_tpl->tpl_vars['messages']->value['calculator']['discount'];?>
 : <span id="object-discount-value"></span></div>
				<div class="clear"></div>
			</div>
			<div class="clear"></div>
		</div>
	...
	<?php  $_smarty_tpl->tpl_vars['ck'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['ck']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['categoryKeys']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['ck']->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars['ck']->iteration=0;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['ckeys']['index']=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['ck']->key => $_smarty_tpl->tpl_vars['ck']->value){
$_smarty_tpl->tpl_vars['ck']->_loop = true;
 $_smarty_tpl->tpl_vars['ck']->iteration++;
 $_smarty_tpl->tpl_vars['ck']->last = $_smarty_tpl->tpl_vars['ck']->iteration === $_smarty_tpl->tpl_vars['ck']->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['ckeys']['index']++;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']['ckeys']['last'] = $_smarty_tpl->tpl_vars['ck']->last;
?>
	<!-- content block -->
	<div class="content-container-item relative">
		<div class="category-item-container relative">
			<!--<img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/transparent-img.png" class="width100" />-->
			<img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->tpl_vars['ck']->value]->categoryItemImage->value;?>
" class="width100" />
			<a href="<?php echo $_smarty_tpl->tpl_vars['app_url']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['currentLang']->value;?>
/category/view/<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->tpl_vars['ck']->value]->id->value;?>
">
			<div class="category-text-container-layer">
				<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['ckeys']['index']=='1'){?>
					<img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/main-category-green-layer.png" />
				<?php }else{ ?>
					<img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/main-category-orange-layer.png" />
				<?php }?>
			</div>
			<div class="category-text <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['ckeys']['index']=='1'){?> category-text-top <?php }?>">
				<a href="<?php echo $_smarty_tpl->tpl_vars['app_url']->value;?>
/<?php echo $_smarty_tpl->tpl_vars['currentLang']->value;?>
/category/view/<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->tpl_vars['ck']->value]->id->value;?>
" class="font16">
					<!--<img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/category-cosmetic.png" class="width100" />-->
					<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->tpl_vars['ck']->value]->categoryItemTitle->value;?>
 (<?php echo $_smarty_tpl->tpl_vars['categories']->value[$_smarty_tpl->tpl_vars['ck']->value]->objCount;?>
)
				</a>
			</div>
			</a>
	...
	<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['ckeys']['index']>1&&!$_smarty_tpl->getVariable('smarty')->value['foreach']['ckeys']['last']){?>
	<!-- tool for adaptive -->
	<div class="clear show-in-767"></div>
	<!-- tool for adaptive end -->
	<?php }?>
...
/img/transparent-img.png" class="width100" />
		<div class="text-layer" class="absolute" >
			<div class="text-right">
				<a href="#">
					<img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/horoscope.png" class="horoscope-icon" />
				</a>
			</div>
			<div class="font25"><?php echo $_smarty_tpl->tpl_vars['messages']->value['horoscope']['title'];?>
</div>
			<br/>
			
			<div class="horoscope-link"><img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/horoscope-arrow.png" class="horoscope-arrow" /><a href="javascript:void(0);" class="color-green a-rhover font16 show-horoscope" sex="0"><?php echo $_smarty_tpl->tpl_vars['messages']->value['horoscope']['man'];?>
</a></div>
			<div class="horoscope-link"><img src="<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/img/horoscope-arrow.png" class="horoscope-arrow" /><a href="javascript:void(0);" class="color-green a-rhover font16 show-horoscope" sex="1"><?php echo $_smarty_tpl->tpl_vars['messages']->value['horoscope']['woman'];?>
</a></div>
		</div>
	</div>
	<!-- content block end -->
