<?php /* Smarty version Smarty-3.1.8, created on 2017-06-27 02:54:38
         compiled from "/Applications/XAMPP/xamppfiles/htdocs/hotel-reservation/views/main/main.tpl" */ ?>
<?php /*%%SmartyHeaderCode:106391967458f66c827afa68-77004178%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd3a2bac863d99f541f2604fd33d99bda4ef955d5' => 
    array (
      0 => '/Applications/XAMPP/xamppfiles/htdocs/hotel-reservation/views/main/main.tpl',
      1 => 1498517435,
      2 => 'file',
    ),
  ...
  'nocache_hash' => '106391967458f66c827afa68-77004178',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.8',
  'unifunc' => 'content_58f66c82a7ce94_99696859',
  'variables' => 
  array (
    'static_url' => 0,
    'app_url' => 0,
...
<?php if ($_valid && !is_callable('content_58f66c82a7ce94_99696859')) {function content_58f66c82a7ce94_99696859($_smarty_tpl) {?><!DOCTYPE HTML>
<html>
<head>
    <meta charset="utf-8">
...
/MainSlide/slide-bg.jpg" style="opacity:0;" alt="slidebg1"  data-bgfit="cover" data-bgposition="left bottom" data-bgrepeat="no-repeat">
							<!-- Layers -->
							<!-- Layer 1 -->
						...
						<li data-transition="boxfade" data-slotamount="7" data-masterspeed="1000" >
							<!-- Main Image -->
							<img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/MainSlide/slide-bg-02.jpg"  alt="darkblurbg"  data-bgfit="cover" data-bgposition="left top" data-bgrepeat="no-repeat">
							<!-- Layers -->
							<!-- Layer 1 -->
							<div class="caption sft revolution-starhotel bigtext"
								 data-x="585"
		...
		<section class="rooms mt50">
			<div class="container">
				<div class="row">
					...
					<!-- Room -->
					<div class="col-sm-4">
						<div class="room-thumb"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/GuestsFavoriteRooms/room-01.jpg" alt="room 1" class="img-responsive" />
							<div class="mask">
								<div class="main">
					...
					<div class="col-sm-4">
						<div class="room-thumb"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/GuestsFavoriteRooms/room-02.jpg" alt="room 2" class="img-responsive" />
							<div class="mask">
								<div class="main">
					...
					<div class="col-sm-4">
						<div class="room-thumb"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/GuestsFavoriteRooms/room-03.jpg" alt="room 3" class="img-responsive" />
							<div class="mask">
								<div class="main">
									<h5>Single room</h5>
		...
		<section class="parallax-effect mt100">
			<div id="parallax-image" style="background-image: url(<?php echo $_smarty_tpl->tpl_vars['static_url']->value;?>
/images/parallax/parallax-01.jpg);">
		...
		<section class="gallery-slider mt100">
			...
			<div id="owl-gallery" class="owl-carousel">
				<div class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/1.jpg" data-rel="prettyPhoto[gallery1]"><img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/1.jpg" alt="Image 1"><i class="fa fa-search"></i></a></div>
				<div class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/2.jpg" data-rel="prettyPhoto[gallery1]"><img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/2.jpg" alt="Image 2"><i class="fa fa-search"></i></a></div>
				<div class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/3.jpg" data-rel="prettyPhoto[gallery1]"><img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/3.jpg" alt="Image 3"><i class="fa fa-search"></i></a></div>
				<div class="item"><a href="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/4.jpg" data-rel="prettyPhoto[gallery1]"><img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/gallery/4.jpg" alt="Image 4"><i class="fa fa-search"></i></a></div>
			</div>
		</section>
				...
				<section class="testimonials mt100">
					<div class="col-md-6">
						...
						<div id="owl-reviews" class="owl-carousel">
							<div class="item">
								<div class="row">
									<div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/reviews/review-01.jpg" alt="Review 1" class="img-circle" /></div>
								...
								<div class="row">
									<div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/reviews/review-02.jpg" alt="Review 2" class="img-circle" /></div>
									<div class="col-lg-9 col-md-8 col-sm-10 col-xs-12">
							...
							<div class="item">
								<div class="row">
									<div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/reviews/review-03.jpg" alt="Review 3" class="img-circle" /></div>
									<div class="col-lg-9 col-md-8 col-sm-10 col-xs-12">
								...
								<div class="row">
									<div class="col-lg-3 col-md-4 col-sm-2 col-xs-12"> <img src="<?php echo $_smarty_tpl->tpl_vars['public_url']->value;?>
/reviews/review-04.jpg" alt="Review 4" class="img-circle" /></div>
									<div class="col-lg-9 col-md-8 col-sm-10 col-xs-12">
