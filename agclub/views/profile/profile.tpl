	...
	<div class="view-page-content font16">
		...
		<div class="profile-page-container">
			<div class="profile-left-side">
				...
				<div class="font15" style="background: none;"><p>{$messages.profile.interests} :</p>{foreach from=$categories item=v key=k name=f_categories}{if in_array($k, $user->interests->value)}<p>{$v}</p>{if !$smarty.foreach.f_categories.last}{/if}{/if}{/foreach}</div>
			</div>
			<div class="profile-right-side">
				<div class="profile-content">
					...
					<div class="profile-field-container">
						...
						<div class="field-own"><input type="text" class="font13" name="surName" autocomplete="off"  value="{$user->surName->value}" /></div>
						<div class="clear"></div>
					</div>
					<div class="profile-field-container">
					...
					<div class="profile-field-container">
						<div class="field-title font13">{$messages.profile.phone}</div>
						<div class="field-own"><input type="text" name="phone" value="{$user->phoneNumber->value}" /></div>
						<div class="clear"></div>
					</div>
					<div class="profile-field-container">
