...
{block name="map-button"}button-inactive{/block}
{block name="list-button"}button-active{/block}
...
{block name="content"}
	...
	<div class="show-more" page-number="1" data-url="{$app_url}/category/view/{$category->id->value}/page/" {if !$enable_more}style="display: none;"{/if}><a href="javascript:showMore();" class="show-more-a" style="text-decoration: none; color: #fff;">Daha artıq göstər</a></div>
