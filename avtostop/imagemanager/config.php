<?
	...
	$mcImageManagerConfig['general.login_page'] = "../admin/";
	$mcImageManagerConfig['general.language'] = "no"; // en, sv
	...
	//$mcImageManagerConfig['filesystem.rootpath'] = 'images/${user}';
	...
	$mcImageManagerConfig['dropdown.cache'] = true;
