<?php
	...
	class ResumeInfoModel extends CRUDModel {
		
		public static function addInfo($userId, $info) {
		...
		public static function editInfo($userId, $info) {
		...
		public static function getResumeInfo($userId) {
