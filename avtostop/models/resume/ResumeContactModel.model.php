<?php
	...
	class ResumeContactModel extends CRUDModel {
		
		public static function addContactResume($userId, $info) {
		...
		public static function editContact($userId, $info) {
		...
		public static function getResumeContact($userId) {
