<?php	
class AvtoAdvicesModel1 extends CRUDModel {	
	public $r_id;	
	public $lang_id;	
	public $itemTitle;	
	public $content;	
	...
	public function __construct() {		
		...
		$this->forLoggedIn = new ModelSelectField("forLoggedIn", $messages['field_forLoggedIn'],
			   Array('0' => Application::$messages['common_messages']['nno'],				
					 '1' => Application::$messages['common_messages']['yyes'],), true, true);			
		$this->forLoggedIn->common = true;		
	}		
	public function getSearchUrl() {	
	    return 'auto/insurance/' . $this->r_id->value;		
	}				
	public static function initialize() {			
	    self::$displayFields = Array('image', 'itemTitle', 'date');			
		self::$title = 'Sığortalan';			
	...
	public static function getNews($newsId, $lang) {		
		...
		return Array('news' => $news, 'comments' => $comments,);	
	}	
}
?>
