<?php
    ...
    class Middleware extends Controller {
		...
		public static function initializeApp($request, $vars = Array()) {
            ...
            //echo "<pre>";  print_r(RegistrationModel::getUserDataByUserEmail('rustam.atakisiev@gmail.com'));  echo "</pre>";
            //self::$smarty->assign('personCount', CompetitionModel::getCompetitionUserCountAfter());

            //echo date("Y-m-d H:i:s");
            //echo LogModel::insertLogEvent('Site User', 'Rustam', 'RustamAtakisiev@gmail.com', '994519943412', 'Registrasiya', '');
            //echo "<pre>"; print_r(RegistrationModel::userActivateOP1('1891')); echo "</pre>";

            //RegistrationModel::userActivateOP('1891');
