<?php
    abstract class BaseModel {
		...
		public static function filterValue($v) {
			return Security::filterSql(Security::filterString($v), self::$mysqli);
		}
		
		public static function filterSql($string) {
			return Security::filterSql($string, self::$mysqli);
		}
