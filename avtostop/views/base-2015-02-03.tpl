	 ...
	 {if isset($competitionTime) and $competitionTime eq true}
		 <div class="competition-block">
			 <div class="left-block">
				 <div class="headers">
					 {if isset($context_cookie.id) or isset($context_session.id)}
						 {if $user eq "true"}<button class="begin-test-button-1">Siz Müsabiqəsiniz</button>
						 {elseif $user eq "false"}<button class="begin-test-button">TEST İMTAHANA BAŞLA</button>{/if}
...
<script type="html/template" id="dynamic-content-1">
    <div class="dynamic-content">
        <h3>Müddət:</h3>
        <span>Müsabiqə 05 yanvar – ............. 2015-ci il tarixində keçiriləcəkdir.</span>
        <h3>İştirakçılar:</h3>
            <span>
        ...
        <h3>Hədiyyə:</h3>
        <span>Müsabiqədə qalib olan şəxs 2 nəfərə ... günlük Parisa səyahət əldə edəcək.</span>
        <h3>Şərtlər:</h3>
            <span>
    ...
    <div class="signin-container">
        <table width="100%">
            ...
            <tr>
                ...
                <td><a id="restore" onclick="passRecovery()">Bərpa et</a></td>
            </tr>
        </table>
