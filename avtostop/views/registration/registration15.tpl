...
{block name="content"}
    ...
    <script src="{$app_url}/client/javascripts/jqueryForm.js"></script>
    <script>
        (function() {
            var bar = $('.bar');
            var percent = $('.percent');
            ...
            $(".dyp-file-fields .check-file a").click(function() {
                ...
                $(".dyp-file-fields #" + currentId + " input").change(function() {
                    ...
                    if(fileName.length == 0) {
                        $(".dyp-file-fields #" + currentId + " a p").html("Fayl yüklə");
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            ...
                            if (data == "errorEmailAndMobile") {
                                ...
                                alert("Sizin telefon nömrənizə təsdiq kodu göndəriləcək. Qeydiyyatı tamamlamaq üçün həmin kodu aşağıdakı xanaya daxil edin.");
                                getCode(mobile);
                            }
                        }
                    });
            ...
            {else}
                ...
                {else}
					<div class="container_1">
                        ...
                        {/literal}
                        <form id="sendFiles" enctype="multipart/form-data" action="{$app_url}/sendAccountImage/add" method="POST">
                            <div class="dyp-file-fields">
                                ...
                                <input type="submit" id="submitAccountImage" value="Upload" style="display: none;">
                            </div>
                        </form><br>
