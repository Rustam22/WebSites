...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<div id="footer" class="relative">
			...
			<div class="p-absolute"  style="width:120px; right:120px; top:33px"><a href="http://www.netty.az/" target="_blank"><img width="120" height="60" border="0" src="http://www.netty.az/img/netty2014.png"></a></div>
			<a href="http://meqa.az" target="_blank"><div class="p-absolute " style=" width:90px; height:40px; right:5px; top:40px"></div></a>
		</div>
