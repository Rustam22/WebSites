...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link rel="stylesheet/less" type="text/css" href="/client/stylesheets/stylesheets.css" />
	...
	<body>
				...
				<div class="right-side left">
					...
					<div class="right-bottom">
						...
						<div class="right auth-container">
							<!--
							<div class="auth-item left auth-item-active"><a href="">регистрация</a></div>
							<div class="left auth-item auth-item-splitter"></div>
							<div class="auth-item left"><a href="">вход</a></div>
							<div class="clear"></div>
							-->
						</div>
						<div class="clear"></div>
			...
			<div id="slider-container">
				<div class="left-side left">
					...
					<div id="advice-container" class="p-relative">
						...
						<div class="faq-title">MÜNTƏZƏM VERİLƏN SUALLARA CAVABLAR</div>
						...
						<div class="not-found-faq-title">
							<span>Axtardığınız suala cavab tapmadınız?</span>
							<div class="faq-input">
							...
							<div class="right" id="ask-question" class="c-pointer">soruş</div>
							<div class="clear"></div>
						</div>
		...
		<div id="footer" class="relative">
			...
			<a href='http://www.meqa.az' target='_blank'><div style="right: 0px; top: 40px; color: #fff; font-size: 13px;  padding: 20px 50px ;" class="p-absolute">
