		...
		<div class="tabs-content-container profile-tabs-content-container">
			...
			<!--About myself-->
					...
					<div class="layer-resume-element">
						<div class="layer-resume-person-title">
							...
							<div class="layer-resume-person-title-description left">
								...
								<div>
									<br/>
									{$m.logo}: <input type="file" name="avatar" />
								</div>
									...
									<div class="resume-person-title-tables-left left">
										...
										<div class="resume-person-title-tables-left-content">
											<div class="resume-person-title-tables-left-content-name tx-margin-top-6px">
												<div><b>{$m.company_name}: </b><span class="editable-input">{if isset($userInfo['name'])}{$userInfo['name']}{else}{$m.empty}{/if}</span>
											...
											<div class="resume-person-title-tables-left-content-age tx-margin-top-6px">
												<span><b>{$m.company_created}: </b></span><span class="editable-input">{if isset($userInfo['birthday'])}{$userInfo['birthday']}{else}{$m.empty}{/if}</span>
						...
						<div class="layer-resume-person-experience">
							...
							<div id="add-experience" class="blue-button">add</div>
						</div>
						-->
						<div class="layer-line-after-cash">
						</div>
					...
					<div class="layer-resume-person-button-big">
						<div class="left">
							<input type="submit" value="{$m.save}" name="save_profile" class="blue-button-input">
						</div>
						<div class="clear"></div>
					</div>
			...
			<div class="tab-content hide p-relative tx-padding-top-10px" style="display: none;">
				...
				<div class="vacancy-item">
					...
					<div class="vacancy-item-actions">
						<div class="left vacancy-item-action">
							<a class="blue-button" href="{$app_url}/vacancy/edit/{$v->id}">{$m.edit}</a>
						</div>
						<div class="left vacancy-item-action">
							<a class="blue-button" href="{$app_url}/vacancy/remove/{$v->id}">{$m.remove}</a>
						</div>
						<div class="clear"></div>
					</div>
				</div>
				...
				<div class="layer-new-resume p-absolute">
					<div class="layer-new-resume-title">
						...
						<div class="layer-title-resume"><span><a class="tx-green-light a-underline" href="">{$m.want_add_vac}</a></span></div><br>
						...
						<div class="layer-person-info-editb left c-pointer">
							...
							<div class="layer-person-info-plusb-title left"><a href="{$app_url}/vacancy/add">{$m.add_vac}</a></div>
						</div>
					</div>
				</div>	
			</div>
