							...
							<!--Private info for resume -->
								<div class="resume-person-title-tables-left left">
									<div class="resume-person-title-tables-left-title">
										<div class="resume-person-title-tables-left-title-item tx-green-light"><span>{$m.priv_info}</span></div>
									</div>
									<div class="resume-person-title-tables-left-content">
										<div class="resume-person-title-tables-left-content-name tx-margin-top-6px">
											<div><b>{$m.name_surname}: </b><span class="">{if isset($userInfo['name'])}{$userInfo['name']}{else}{$m.empty}{/if}</span></div>
										</div>
										<div class="resume-person-title-tables-left-content-age tx-margin-top-6px">
											<span><b>{$m.birthday}: </b></span><span class="">{if isset($userInfo['birthday'])}{$userInfo['birthday']}{else}{$m.empty}{/if}</span>
										</div>
										...
										<div class="resume-person-title-tables-left-content-city tx-margin-top-6px">
											<div class="profile-field-container">
												<div class="profile-field-title left">
													<b>{$m.sex}: </b> {if isset($userInfo['sex'])}{$sex[$userInfo['sex']]}{else}{/if}
												</div>
												<div class="clear"></div>
											</div>
										</div>
								...
								<div class="resume-person-title-tables-left left">
									...
									<div class="resume-person-title-tables-left-content">
										<div class="resume-person-title-tables-left-content-name tx-margin-top-6px">
											...
											<span class="">{if isset($userWishes['profession']) && !empty($userWishes['profession'])}{$userWishes['profession']}{else}{$m.empty}{/if}</span>
										</div>
										<div class="resume-person-title-tables-left-content-age tx-margin-top-6px">
											<span><b>{$m.salary}:</b></span>
											<span class="">{if isset($userWishes['salary']) && !empty($userWishes['salary'])}{$userWishes['salary']}{else}{$m.empty}{/if}</span>
										</div>
										<div class="resume-person-title-tables-left-content-city tx-margin-top-6px">
											<div class="profile-field-container">
												<div class="profile-field-title left">
												...
												<div class="profile-field-own left">
													<div id="profile-wish-country" >
														<span class=" ">{$userWishes['city']}</span>
													</div>
												</div>
												<div class="clear"></div>
											</div>
						...
						<div class="resume-person-profession-content tx-margin-top-6px">
							<div class="profession-content-education">
								<div class="profile-field-container">
									...
									<div class="profile-field-own profile-field-own-textarea left">
										<span class="">{if isset($userInfo['education']) && !empty($userInfo['education'])}{$userInfo['education']}{else}{$m.empty}{/if}</span>
									</div>
									<div class="clear"></div>
								</div>
							</div>
							<div class="profession-content-education">
								<div class="profile-field-container">
									...
									<div class="profile-field-own profile-field-own-textarea left">
										<span class="">{if isset($userInfo['courses']) && !empty($userInfo['courses'])}{$userInfo['courses']}{else}{$m.empty}{/if}</span>
									</div>
									<div class="clear"></div>
								</div>
							</div>
							<div class="profession-content-education">
								<div class="profile-field-container">
									...
									<div class="profile-field-own profile-field-own-textarea left">
										<span class="">{if isset($userInfo['skills']) && !empty($userInfo['skills'])}{$userInfo['skills']}{else}{$m.empty}{/if}</span>
									</div>
									<div class="clear"></div>
								</div>
							</div>
