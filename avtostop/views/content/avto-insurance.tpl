...
{block name="content"}
	...
	<div class="faq-title">Sığortalan</div>
	...
	<div class="page-content">
		...
		{foreach from=$advices item=a}
			...
			<div class="advice-item">
				...
				<div class="advice-item-title"><a href="{$app_url}/auto/insurance/{$a.r_id}">{$a.itemTitle}</a></div>
		...
		<div class="advice-paginator-container">
			<div class="advice-paginator-item"><a href="{$app_url}/auto/insurances/page/{$to_left}">&laquo;</a></div>
			
			{section name=adv_pag loop=$pages }
				<div class="advice-paginator-item"><a href="{$app_url}/auto/insurances/page/{$smarty.section.adv_pag.index}">{$smarty.section.adv_pag.index + 1}</a></div>
			{/section}
			
			<div class="advice-paginator-item"><a href="{$app_url}/auto/insurances/page/{$to_right}">&raquo;</a></div>
		</div>
		{/if}
