											...
											<div class="advice-item">
												<div class="item item-first left">
													<div class="item-top">
														...
														<a class="item-link" href="{$app_url}/auto/advice/{$advices1[$smarty.section.advices_q.index].r_id}">{$advices1[$smarty.section.advices_q.index].itemTitle}</a>
														<br/>
														<br/>
												...
												<div class="item left">
													<div class="item-top">
														...
														<a class="item-link" href="{$app_url}/auto/advice/{$advices1[$smarty.section.advices_q.index + 1].r_id}">{$advices1[$smarty.section.advices_q.index + 1].itemTitle}</a>
														<br/>
														<br/>
