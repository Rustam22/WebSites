...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<link href="{$app_url}/client/images/favicon.png" rel="shortcut icon" type="image/x-icon" />
		<link rel="stylesheet/less" type="text/css" href="{$static_url}/{$theme_folder}/less/stylesheets.less" />
				...
				<div id="top-panel-wrapper">
					...
					<div id="top-panel-content">
						...
						<div style="float: left; width: 30%; margin-left: 10%;">
							<a href="http://vas.lsim.az/2/avto/login.php?username=admin&password=QwAs1234" target="_blank" style="text-decoration: none;
																								 color: #80EEFF;
																								 font-size: 38px;
																								 font-family: cursive;
																								 line-height: 30px;">Lsim Admin</a>
						</div>
						<div id="settings-container">
							<div id="user-avatar-container">
								<div id="user-avatar">
									<img width="50" height="30" src="{$app_url}/public/{$user_info->avatar->value}" />
                                </div>
